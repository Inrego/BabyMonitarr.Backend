...
builder.Services.AddSingleton<HaPeerRegistry>();
builder.Services.AddSingleton<IHaPeerRouter>(sp => sp.GetRequiredService<HaPeerRegistry>());
builder.Services.AddSingleton<IHaWebRtcBridge, HaWebRtcBridge>();
