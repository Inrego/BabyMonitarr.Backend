...
BabyMonitarr exposes a SignalR hub for building custom clients that connect to the audio/video streams. This document covers the full WebRTC signaling protocol, data channel message formats, and includes a complete JavaScript example.
